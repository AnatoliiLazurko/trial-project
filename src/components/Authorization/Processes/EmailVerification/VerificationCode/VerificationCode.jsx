...
import styles from './VerificationCodeStyles.module.css';
...
const VerificationCode = () => {
    ...
    return (
        <div className={styles["verification-code-container"]}>
            <svg className={styles["back-arrow"]} viewBox="0 0 25 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" onClick={navigateToEmailInput}>
            ...
            <p className={styles["subtitle"]}>We sent you a code to your email for verification </p>
